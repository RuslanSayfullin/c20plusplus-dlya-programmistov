...
$(document).ready(function() {
	...
	if ($("#id_tip_dogovora").val() == "technic_2021_04_ip_frolov" || $("#id_tip_dogovora").val() == "technic_2021_04_ip_bagautdinov" || $("#id_tip_dogovora").val() == "technic_2021_04_ip_sadykov" || $("#id_tip_dogovora").val() == "technic_2021_04_ip_hafizov" || $("#id_tip_dogovora").val() == "m_householdtec_ip_frolov" || $("#id_tip_dogovora").val() == "m_householdtec_ip_bagautdinov" || $("#id_tip_dogovora").val() == "m_householdtec_ip_sadykov" || $("#id_tip_dogovora").val() == "m_householdtec_ip_hafizov" || $("#id_tip_dogovora").val() == "m_mattresses_ip_frolov" || $("#id_tip_dogovora").val() == "m_mattresses_ip_bagautdinov" || $("#id_tip_dogovora").val() == "m_mattresses_ip_sadykov" || $("#id_tip_dogovora").val() == "m_mattresses_ip_hafizov" || $("#id_tip_dogovora").val() == "matrasy_2021_06_frolov" || $("#id_tip_dogovora").val() == "matrasy_2021_06_bagautdinov" || $("#id_tip_dogovora").val() == "matrasy_2021_06_sadykov" || $("#id_tip_dogovora").val() == "matrasy_2021_06_hafizov") {
	...
	if ($("#id_tip_dogovora").val() == "technic_2021_04_ip_frolov" || $("#id_tip_dogovora").val() == "technic_2021_04_ip_bagautdinov" || $("#id_tip_dogovora").val() == "technic_2021_04_ip_sadykov" || $("#id_tip_dogovora").val() == "technic_2021_04_ip_hafizov" || $("#id_tip_dogovora").val() == "matrasy_2021_06_frolov" || $("#id_tip_dogovora").val() == "matrasy_2021_06_bagautdinov" || $("#id_tip_dogovora").val() == "matrasy_2021_06_sadykov" || $("#id_tip_dogovora").val() == "matrasy_2021_06_hafizov" || $("#id_tip_dogovora").val() == "mattresses_ooo-refabrik" || $("#id_tip_dogovora").val() == "m_householdtec_ip_frolov" || $("#id_tip_dogovora").val() == "m_householdtec_ip_bagautdinov" || $("#id_tip_dogovora").val() == "m_householdtec_ip_sadykov" || $("#id_tip_dogovora").val() == "m_householdtec_ip_hafizov" || $("#id_tip_dogovora").val() == "m_mattresses_ip_frolov" || $("#id_tip_dogovora").val() == "m_mattresses_ip_bagautdinov" || $("#id_tip_dogovora").val() == "m_mattresses_ip_sadykov" || $("#id_tip_dogovora").val() == "m_mattresses_ip_hafizov" ) {
